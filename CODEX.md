...
runs. Background quota polling uses the saved
access token without OAuth refresh or writes to active authentication. The
running Desktop owns refresh-token rotation; after its exact main process and
