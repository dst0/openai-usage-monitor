...
public final class LocalizationManager: @unchecked Sendable {
  ...
  public static func detectSystemLanguage(preferences: [String] = Locale.preferredLanguages)
    -> AppLanguage
  {
  ...
  public static let translations: [AppLanguage: [String: String]] = [
    .ru: [
      ...
      "personal_accounts": "Личные аккаунты",
      ...
      "add_account_browser_prompt":
        "Открываем браузер для входа. Пожалуйста, завершите авторизацию...",
      ...
      "auto_reset_weekly_more_than_days": "Больше %d дн.",
      "auto_reset_weekly_custom": "Другое число часов…",
      "auto_reset_weekly_custom_value": "Другое: %d ч",
      "auto_reset_weekly_status": "Статус: %@",
    ...
    .en: [
      ...
      "add_account_browser_prompt":
        "Opening browser for login. Please complete authentication in your browser...",
      ...
      "auto_reset_weekly_more_than_days": "More than %d days away",
      "auto_reset_weekly_custom": "Custom hours…",
      "auto_reset_weekly_custom_value": "Custom: %d hours",
      "auto_reset_weekly_status": "Status: %@",
    ...
    .uk: [
      ...
      "add_account_browser_prompt":
        "Відкриваємо браузер для входу. Будь ласка, завершіть авторизацію...",
    ...
    .es: [
      ...
      "add_account_msg":
        "Introduce el identificador de la cuenta (ej. personal, trabajo, equipo-2):",
      "add_account_login_browser": "Iniciar sesión en navegador",
      "add_account_save_current": "Guardar sesión actual",
      "add_account_browser_prompt":
        "Abriendo el navegador para iniciar sesión. Por favor completa la autenticación...",
    ...
    .pt: [
      ...
      "auto_switch_business_priority":
        "⚡ Alternância automática com prioridade para contas de negócios",
    ],
    .pl: [
      "menu_title": "OpenAI Codex Quota Monitor",
      ...
      "add_account_browser_prompt":
        "Otwieranie przeglądarki w celu logowania. Ukończ autoryzację w przeglądarce...",
    ...
    .nl: [
      ...
      "auto_switch_business_priority":
        "⚡ Automatisch overschakelen met voorrang voor zakelijke accounts",
    ],
    .ja: [
      "menu_title": "OpenAI Codex Quota Monitor",
    ...
    .vi: [
      ...
      "add_account_browser_prompt":
        "Đang mở trình duyệt để đăng nhập. Vui lòng hoàn tất xác thực trong trình duyệt...",
...
public enum L10n {
  ...
  public static var personalAccounts: String { tr("personal_accounts") }
  ...
  public static func autoResetWeeklyMoreThan(days: Int) -> String {
    String(format: tr("auto_reset_weekly_more_than_days"), days)
  }
  public static var autoResetWeeklyCustom: String { tr("auto_reset_weekly_custom") }
  public static func autoResetWeeklyCustomValue(hours: Int) -> String {
    String(format: tr("auto_reset_weekly_custom_value"), hours)
  }
  public static func autoResetWeeklyStatus(_ status: String) -> String {
    String(format: tr("auto_reset_weekly_status"), status)
  }
  public static var autoResetWeeklyEnableTitle: String { tr("auto_reset_weekly_enable_title") }
  public static var autoResetWeeklyEnableMessage: String { tr("auto_reset_weekly_enable_message") }
  public static var autoResetWeeklyEnableButton: String { tr("auto_reset_weekly_enable_button") }
