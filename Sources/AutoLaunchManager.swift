...
public final class AutoLaunchManager {
    ...
    public var appPath: String {
        ...
        let userAppPath = (fileManager.homeDirectoryForCurrentUser.path as NSString).appendingPathComponent("Applications/Codex Monitor.app")
    ...
    public var isEnabled: Bool {
        ...
        if result.exitCode == 0 {
            let items = result.output.components(separatedBy: ",").map { $0.trimmingCharacters(in: .whitespacesAndNewlines) }
